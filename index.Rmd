...
# Study System: *Helianthus verticillatus* and Relatives

*Helianthus verticillatus* Small (Asteraceae), also known as the whorled sunflower, provides an ideal system for demonstrating the application of such approaches. This perennial diploid species is federally listed as endangered and is endemic to the southeastern United States [@matthews2002]. Only four populations in Alabama, Georgia, and two counties in Tennessee (McNairy Co. and Madison Co.) were known for many years following its rediscovery in the 1990s, prompting initial conservation genetic studies using microsatellite markers to evaluate patterns of genetic diversity and population structure [@ellis2006; @mandel2010]. These studies provided important insights into the distribution of genetic variation among populations and informed conservation management decisions in various states, leading to its federally endangered status in 2014 [@usfws2014]. Following that work, additional populations were discovered in Mississippi and Virginia in 2017 and 2019, respectively. These discoveries prompted more population genetic work which found that the Mississippi (hereafter referred to as whorled-Marshall or ‘w-Marshall’) and Virginia sites harbor novel genetic variation in comparison to the previously known populations, and w-Marshall harbored the most private alleles of all populations tested [@moore2022]. These results led to annual land surveys in Mississippi with hopes to find more populations that may explain this variation.

In 2022, additional populations were discovered in Mississippi, with larger populations found in the Yazoo-Mississippi Delta (hereafter ‘Delta’) region that is nestled between the Mississippi and Yazoo rivers (USA) [@cobb1994], as well as some smaller populations in the northern portion of the state (hereafter ‘Northern Mississippi’). However, these populations exhibited unexpected phenotypes compared to typical *H. verticillatus*, and had intermediate morphologies between *H. verticillatus* and *Helianthus grosseserratus* M.Martens [@heiser1969], a closely related species found in the central to eastern regions of North America [@stephens2015]. Given that both species have overlapping ranges, and that *H. verticillatus* was once hypothesized to have a hybrid origin with other *Helianthus* species, including *H. grossesserratus* [@beatley1963; @heiser1969; @cronquist2001; @matthews2002], there is a need to reassess patterns of genetic diversity and population structure across this species using genome-scale data.

## Applicability to this Workflow 

In this study, we demonstrate an accessible and reproducible workflow for generating and analyzing SNP datasets derived from target-capture sequencing data in a conservation genomics framework. Using *H. verticillatus* as a case study, we evaluate genetic diversity and population structure across multiple previously known and newly discovered populations in Mississippi (hereafter referred to as *Helianthus* sp.), and compare our results with previous conservation genetic analyses based on microsatellites. By providing a transparent pipeline that can be applied to any species or target-capture probe set, this study illustrates how target-capture datasets can be leveraged to address conservation genomic questions and inform management decisions for rare and endangered species.
...
Leaf tissue was sampled from all known wild populations of *Helianthus verticillatus*: Alabama, Georgia, McNairy (Tennessee), Pinson (Tennessee), w-Marshall (Mississippi), and Virginia. This study recognizes Alabama as having two subpopulations, Alabama1 and Alabama2, due to previously observed ecological and morphological differences (see [@mandel2010]). Seeds were obtained from the two available accessions of *H. verticillatus* maintained by the United States Department of Agriculture–Agricultural Research Service (USDA-ARS). Leaf tissue was sampled from all known populations of *Helianthus* sp. in Mississippi: Belzonia, Benton, Greenwood, Grenada, Marshall, and Tchula. Additionally, seeds were obtained from eight USDA-ARS accessions of *H. grosseserratus* populations, spanning its geographic range: Illinois, Iowa, Kansas, Mississippi, Nebraska, North Dakota, Oklahoma, and Wisconsin. *Helianthus grosseserratus* was included because of its overlapping range and suspected hybridizations with *H. verticillatus* [@beatley1963; @heiser1969; @cronquist2001; @matthews2002]. Some downstream analyses require the inclusion of an outgroup, so a single individual of *Helianthus schweinitzii* Torr. & A.Gray was included.
...
Target sequence capture using the custom probe set MyBaits Compositae-1061 kit [@mandel2014] from Arbor Biosciences was performed on the libraries following manufacturer’s protocols (version 2.3.1). Pools were created using five to seven libraries, with a goal of 150 ng of DNA per individual library in the capture pools for the MyBaits reaction. Hybridization with the baits took place in the thermocycler for 36 hours at 62°C. The hybridized targets were recovered by Dynabeads M-280 Streptavidin beads (ThermoFisher Scientific, Vilnius, Lithuania) following protocols developed by the manufacturer. A 1:4 ratio of each library was added to the pools after target capturing to obtain off-target plastid sequence data. Qubit HS assay was used to quantify the samples, and Agilent Bioanalyzer (Agilent Technologies, Santa Clara, California, USA) was used to quality check the captured pools. The pooled captures were shipped to Psomagen for Illumina Sequencing using NovaSeqX and HiSeqX machines (Appendix S2). 
